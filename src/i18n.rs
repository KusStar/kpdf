...
macro_rules! locale_message_fields {
    ($macro:ident) => {
        $macro! {
            ...
            bitmap_len_mismatch,
            copy_button,
            add_markdown_note_here_button,
            edit_markdown_note_button,
            delete_markdown_note_button,
            copy_markdown_note_button,
            markdown_note_new_dialog_title,
            markdown_note_edit_dialog_title,
            markdown_note_dialog_hint,
            markdown_note_input_placeholder,
            markdown_note_preview_label,
            markdown_note_save_button,
            markdown_note_cancel_button,
